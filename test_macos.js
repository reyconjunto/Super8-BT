var document = {
    ...
    getElementById: function() { return { innerText: '' }; },
    addEventListener: function() {}
};
var window = { location: { search: '' }, origin: '', pathname: '' };
...
App.state.players = [];
for(var i=0; i<8; i++) {
    App.state.players.push({id: 'p_'+i, name: 'P'+i, isSeed: false});
}

try {
    console.log("Generating rounds...");
    var result = IndividualMode.generateRounds(App.state.players);
