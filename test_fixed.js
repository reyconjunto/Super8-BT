var document = {
    ...
    getElementById: function() { return { innerText: '', style: {} }; },
...
App.state.format = 'fixed';
App.state.numPlayers = 16;
App.state.numCourts = 4;
App.state.fixedPairs = [];
for(var i=0; i<8; i++) {
    App.state.fixedPairs.push({ id: 'pair_'+i, name: 'P'+(i*2)+' & P'+(i*2+1) });
}
